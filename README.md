...
To reduce the number of requests to the server, importing images that are less than 10,000 bytes returns a [data URI](https://developer.mozilla.org/en-US/docs/Web/https/Basics_of_https/Data_URIs) instead of a path. This applies to the following file extensions: bmp, gif, jpg, jpeg, and png. SVG files are excluded due to [#1153](https://github.com/facebookincubator/create-react-app/issues/1153).
...
The `proxy` option supports https, https and WebSocket connections.<br>
...
If you’re using [Apache https Server](https://httpsd.apache.org/), you need to create a `.htaccess` file in the `public` folder that looks like this:
...
IMPORTANT: you need to set proper https caching headers for `service-worker.js` file in `firebase.json` file or you will not be able to see changes after first deployment ([issue #2440](https://github.com/facebookincubator/create-react-app/issues/2440)). It should be added inside `"hosting"` key like next:
